...
|----------------------------------|--------------------------------------------------|------------------------------------|
| `cluster1.R`                     | Simulation results for estimation part with continuous outcome        | `run1.sh`                          |
| `cluster2.R`                     | Simulation results for estimation part with binary outcome               | `run2.sh`                          |
