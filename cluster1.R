...
# dat_try <- dat_gen(10000)
# npest(dat_try)
# 
# mean(dat_try$y_1[which((dat_try$s=="SWI1")|(dat_try$s=="SWI2"))]-
#        dat_try$y_0[which((dat_try$s=="SWI1")|(dat_try$s=="SWI2"))])

simu_res = NULL
beta_list <- list(c(2,2,2),c(4,4,4))
...
FileSave <- paste0("/home/bzhang3/Wang_Rui/nested_iv/output1/sim_",touse,".csv")
